...
// and a planted downforce car (the chain can't hook it)
const chainProof = c => isRobot(c) || away(c) || planted(c) || (c.ability?.active > 0 && (c.ability.id === 'shield' || c.ability.id === 'phase'));
